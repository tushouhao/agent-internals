# 文件名: key_detect_medium.py
# 功能: 关键检测信息介质三策略权衡，止于综合检测完备率
# 运行: python key_detect_medium.py

"""关键检测信息介质选择：本地 vs 远程 vs 云端。"""
...
def simulate_medium(n: int = 90) -> dict:
    ...
    for i in range(n):
        ...
        if medium == "local":
            ...
            r = remote_db_key(data)
        else:
            r = cloud_key_service(data)
